...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2022 at 07:11 AM
...
('Anish ', 'Shahi', 19, 'Chal chaiya chiya ', 'Om shanti om', 'sharuk Khan'),
('Samrat ', 'Acharya', 20, 'Darde disco ', 'dil wale dulhaniya le jayenge', 'Amir Khan'),
('utshab ', 'Adhikari', 20, 'bhagwan he kaha re tu', 'pk', 'Amir Khan');
COMMIT;
